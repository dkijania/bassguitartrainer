...
namespace BassTrainer.UI.WPF.WpfControls
{
    ...
    public partial class SelectionControl : UserControl
    {
        ...
        public void ColorOctaveButton(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            ComponentsLocator.Instance.FretboardComponent.FretBoard.FretBoardGuiBuilder.ApplyColorForOctaves = toggleButton.IsChecked.Value;
        }

        public void ColorEquivalentNotes(object sender, System.Windows.RoutedEventArgs e)
        {
            var toggleButton = (ToggleButton)sender;
            ComponentsLocator.Instance.FretboardComponent.FretBoard.FretBoardGuiBuilder.ApplyColorForNotes= toggleButton.IsChecked.Value;
        }
    }
}
